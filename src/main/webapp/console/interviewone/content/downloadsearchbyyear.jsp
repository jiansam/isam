...
<div>
	<div style="float: left;width: 100%;">
		<form class="searchForm" action='<c:url value="/interviewone/downloadbyyear.jsp"/>' method="post">
			    ...
			    <table style="width: 95%;padding-left: 20px;">
					<tr>
						...
						<td style="width: 30%;padding: 5px 0px;">
							...
							<input type="radio" name="type" value="3" id="type3"><label for="type3">全部</label>
						</td>			
					</tr>
