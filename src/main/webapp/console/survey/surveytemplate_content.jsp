...
<div id="mainContent">
	<fieldset style="-moz-border-radius:6px; -moz-border-top-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-right-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-left-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-bottom-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc;">
		...
		<fieldset>
			<legend>
				<span class="legendStepTitle">[&nbsp;編輯空白問卷下載&nbsp;]</span>
				<c:if test="${fn:contains(memberUrls,'A0201') || fn:contains(memberUrls,'E0201')}">
					<input type="button" class="btn_class_opener" value="新增空白問卷" onclick="surveyFile.show()"/>
				</c:if>
			</legend>
						...
						<tr>
							...
							<c:forEach var="file" items="${year_files[year]}">
								...
								<c:if test="${not empty file}">
									<td><a style="padding-left: 25px;" href="<c:url value="/console/survey/surveyFileLoad.view?id=${file.id}" />" >
										<img src='<c:url value="/images/pdf.png" />' width="22" title="${file.file_title}" alt="${file.file_title}"/></a>
										
										&nbsp;
										<c:url value="/console/survey/surveyFile.view" var="rmv" scope="page">
			...
			<br/><br/><br/>
			<hr>
				<form action="${pageContext.request.contextPath}/console/survey/surveyFileUpload.view" method="post" onsubmit="surveyFile.checkData();" enctype="multipart/form-data"  style="width:50%; margin:0 auto;">
