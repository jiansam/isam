...
$(function() {
	...
	if("${param.editType}"==="edit"){
		...
		getRestrainTables(idno,type,"${param.editType}",obj1,obj2);
	}else{
		getRestrainTables(idno,type,"${param.editType}");
	}
});
</script>
			...
			<div id="formAddCN" style="margin-top: 30px;">
				<table class="formProj" style="width:95%;font-size: 16px;">
					<tr>
						...
						<td style="width: 15%;"><input type="text" name="AInvestNo" maxlength="6" style="width: 95%;font-size: 14px;" class="nextFocus" title="請輸入以6開頭共六碼的案號"/></td>
