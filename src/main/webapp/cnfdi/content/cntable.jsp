...
$(function() {
	var y=$.extend({
		"aaSorting": [[ 1, "desc" ],[2,"asc"]],"aoColumnDefs": [{ 'sClass':'center', "aTargets": [ 0,1,2,3,5,6,7 ] },
...
//			postUrlByForm('/showapproval.jsp',{'investNo':investNo});
			postOpenUrlByForm1('/showapproval.jsp',{'investNo':investNo});
		}else{
	 		postUrlByForm('/audittopdf.jsp',{'investNo':investNo});
		}
	});
});
</script>
			...
			<tbody>
				<c:forEach var="list" items="${ofilist}">
					<tr>
						...
						<td><img alt="下載事後管理應注意事項表" src='<c:url value='/images/pdf.png'/>'></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
