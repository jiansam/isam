...
$(function() {
	...
	<c:choose>
	<c:when test="${ofiIOterms.investNo!='' || ofiIOterms.BG1 !='' || ofiIOterms.BG2 !='' || ofiIOterms.nation!='' || ofiIOterms.relatedNation!=''}">
	setCheckboxToDefalutWithEmpty("companytype","1");
	</c:when>
	<c:otherwise>	setCheckboxToDefalutWithEmpty("companytype","${ofiIOterms.companytype}");</c:otherwise>
	</c:choose>
...
<div>
	<div style="float: left;width: 100%;">
		<form class="searchForm" action='<c:url value="/cnfdi/listinvestor.jsp"/>' method="post">
		   	...
		   	<div class="ui-widget ui-widget-content ui-corner-all" style="padding: 5px;font-size: 16px;">
			    <table style="width: 98%;padding-left: 20px;">
					<tr>
						<td  width="500" class="tdRight">陸資案號：</td>				
						<td><input type="text" maxlength="6" name="investNo" value="${ofiIOterms.investNo }"/></td>				
								
					</tr>
						<tr>
							<td class="tdRight">統一編號(含辦事處)：</td>				
						<td colspan="3"><input type="text" name="IDNO" maxlength="8"  value="${ofiIOterms.IDNO }"/></td>	
					...
					<tr>
						<td class="tdRight" width="200px" >&nbsp;&nbsp;&nbsp;&nbsp;投資人<span>(含辦事處)</span>：</td>				
						<td colspan="3"><input type="text" name="investor" style="width:200px;"  value="${ofiIOterms.investor }"/></td>			
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="investorXRelated" style="width:680px;" value="${ofiIOterms.investorXRelated}"/></td>				
					</tr>
					<tr>
