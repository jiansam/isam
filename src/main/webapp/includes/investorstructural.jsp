...
<%@ page import="com.isam.service.ofi.OFIInvestorXFileService"%>
...
<%
	...
	List<OFIInvestorXFile> list = ser.select(request.getParameter("investorSeq"));
	request.setAttribute("ofifiles",list);
%>
