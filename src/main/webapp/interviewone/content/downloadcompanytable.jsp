...
<script src="<c:url value='/media/js/TableTools.min.js'/>"  type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/media/js/ZeroClipboard.js'/>"  type="text/javascript" charset="utf-8"></script>
<script>
/*核准資料的datatable*/
function getOptionTable(aoColumnsary,notbSortable){
	var option={
			...
			/* "sPaginationType" : "full_numbers", */  //顯示全部的分頁
			//多語言配置
			"oLanguage" : {
				"sProcessing" : "正在載入中......",
...
$(function() {
	...
	$(".selectAll").click(function(){
		 ...
		 $('input:checkbox', $("#example")).each( function() {
	...
	$("#downloadSelected").click(function(event){
		if($('input:checkbox:checked', $("#example")).length==0){
			alert('請選擇一筆資料');
...
<div>
	<fieldset style="-moz-border-radius:6px; -moz-border-top-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-right-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-left-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-bottom-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc;">
		...
		<div>
		<form id="downloadform" action='<c:url value="/interviewone/downloadzip"/>' method="post">
		<table id="example" class="display" style="width: 98%;"> 
			...
			<tbody>
				<c:forEach var="bean" items="${Interviewone}">
					<tr>
					<td>
					<input type="checkbox" name="investNo" value="${bean.interviewFNo}|${bean.surveyFNo}"/>
					</td>
