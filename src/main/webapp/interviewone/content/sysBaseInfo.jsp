...
<fieldset>
	...
	<div class="ui-widget ui-widget-content ui-corner-all" style="padding: 5px;font-size: 16px;">
		<table>
			<tr>
				<th class="trRight"  style="width: 18%;">調查年度：</th>
				<td  style="width: 18%;"><span>${IObean.year}年</span></td>
				<th class="trRight"  style="width: 18%;">事業名稱：</th>
				<td>${IOBaseInfo.cname}</td>
			</tr>
			<tr>
				<th class="trRight">陸資案號：</th>
				<td>
					<span>
