						...
						<tr>
							...
							<c:forEach var="file" items="${year_files[year]}">
								...
								<c:if test="${not empty file}">
									<td><a href="<c:url value="/survey/filledSurveyFileLoad.view?id=${file.id}" />" >
										<img src='<c:url value="/images/download.png" />' width="22" title="${file.file_title}" alt="${file.file_title}"/></a></td>
								</c:if>
