...
<div id="mainContent">
	<fieldset style="-moz-border-radius:6px; -moz-border-top-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-right-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-left-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc; -moz-border-bottom-colors:#fff #ccc #ccc #ccc #ccc #ccc #ccc #ccc #ccc;">
		<legend style="text-align:center;padding:5px;width:200px;border-top:1px solid #E6E6E6;margin-bottom: 10px;background-color: #66cccc;-webkit-border-radius: 30px; -moz-border-radius: 30px;border-radius: 30px;">
			<span style="color:#F30;"><strong>&nbsp;檢視未核准案件&nbsp;</strong>&nbsp;</span>
		</legend>
		<div>
				...
				<legend style="width:100%;border-top:1px solid #E6E6E6;padding-top: 10px;">
				    ...
				    <table style="width: 98%;font-size: 16px;" class="formProj">
						...
						<tr>
							...
							<td colspan="3">${opt.currency[rejectObj.currency]}
							&nbsp;
								<c:if test="${not empty rejectObj.moneyother && opt.currency[rejectObj.currency]=='其他' }">
								 (${rejectObj.moneyother})
							
								</c:if>
								
								<c:if test="${not empty rejectObj.money && opt.currency[rejectObj.currency]!='其他'}"><span class="numberFmt">${rejectObj.money}</span>&nbsp;元</c:if>
						...
						<td class="trRight">持股比例：</td>
							<td colspan="3" ><span class="numberFmt">${rejectObj.shareholding}</span>&nbsp;%
							</td>
						</tr>
						<tr>
