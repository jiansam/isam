...
public class OFIShowInvestorFormServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		session.setAttribute("bgs", bgSer.getBGMapStr(investorSeq));
		session.setAttribute("isbg", bgSer.isEditable(investorSeq));
		...
		response.sendRedirect(path + "/console/cnfdi/investor.jsp");		
	}
}
