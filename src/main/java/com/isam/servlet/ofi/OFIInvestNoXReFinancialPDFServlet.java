...
public class OFIInvestNoXReFinancialPDFServlet extends HttpServlet{
	private PDFUtil pf;
	private InterviewoneHelp opt;
	private OFIReInvestNoXFContentService fcSer;
	private OFIReInvestNoXFinancialService fSer;
	...
	public void init(ServletConfig config) throws ServletException {
		...
		fcSer= new OFIReInvestNoXFContentService();
		fSer = new OFIReInvestNoXFinancialService();
		pf=new PDFUtil();
		setFontSelector();
	}
	...
	protected void doGet(HttpServletRequest request,
		...
		OFIInvestNoXFinancial fbeanlast=fSer.selectbean(reInvestNo, lastyear);
...
//		String str=investNo.substring(0,1).equals("4")?"（陸分）"+investNo:"（陸）"+investNo;
		...
		String dfilename ="財務資訊簡表_"+tt+".pdf";
		try {
